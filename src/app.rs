...
pub fn app() -> App<'static, 'static> {
    App::new("bobbin")
        ...
        .subcommand(SubCommand::with_name("list")
            ...
            .arg(Arg::with_name("remote").long("remote").takes_value(true).help("Specify the remote host to use."))
            .about("Display a list of debug devices")
        )
        .subcommand(SubCommand::with_name("info")
            .arg(Arg::with_name("remote").long("remote").takes_value(true).help("Specify the remote host to use."))
            .arg(Arg::with_name("remote-device").long("remote-device").takes_value(true).help("Specify the remote device to use."))
        ...
        .subcommand(SubCommand::with_name("load")
            ...
            .arg(Arg::with_name("remote").long("remote").takes_value(true).help("Specify the remote host to use."))
            .arg(Arg::with_name("remote-device").long("remote-device").takes_value(true).help("Specify the remote device ID to use."))
