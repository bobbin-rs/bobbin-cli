...
pub fn app() -> App<'static, 'static> {
    App::new("bobbin")
        ...
        .subcommand(SubCommand::with_name("build")
            ...
            .arg(Arg::with_name("xargo").long("xargo"))
            .arg(Arg::with_name("make").long("make").takes_value(true).multiple(true).min_values(0))
            .arg(Arg::with_name("no-build").long("no-build"))
        )
        .subcommand(SubCommand::with_name("load")
            .arg(Arg::with_name("binary").long("binary").takes_value(true))
            .arg(Arg::with_name("target").long("target").takes_value(true))
            .arg(Arg::with_name("bin").long("bin").takes_value(true))
            .arg(Arg::with_name("example").long("example").takes_value(true))
            .arg(Arg::with_name("release").long("release"))
        ...
        .subcommand(SubCommand::with_name("run")
            ...
            .arg(Arg::with_name("itm").long("itm"))
        )
